...
import com.example.directorystoreapp.adapter.ExploreFeedAdapter
...
class ExploreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val postRecycler = view.findViewById<RecyclerView>(R.id.explore_feed)

        val adapter = activity?.applicationContext?.let { RecentlyAddedAdapter(it, getImages()) }
